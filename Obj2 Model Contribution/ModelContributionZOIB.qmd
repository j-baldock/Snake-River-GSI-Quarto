...
```{r echo=FALSE, message=FALSE, results='hide'}
jpeg("/Users/jeffbaldock/Library/CloudStorage/GoogleDrive-jbaldock@uwyo.edu/Shared drives/wyo-coop-baldock/UWyoming/Snake River Cutthroat/Analyses/Snake River GSI Quarto/Obj2 Model Contribution/RandomEffects_Repunit.jpg", units = "in", width = 6, height = 8, res = 1000)
print(p1)
dev.off()
```
...
```{r echo=FALSE, message=FALSE, results='hide'}
jpeg("/Users/jeffbaldock/Library/CloudStorage/GoogleDrive-jbaldock@uwyo.edu/Shared drives/wyo-coop-baldock/UWyoming/Snake River Cutthroat/Analyses/Snake River GSI Quarto/Obj2 Model Contribution/ZeroInflation_Connectivity.jpg", units = "in", width = 4, height = 3.5, res = 1000)
...
# plot
plot(c(1:4) ~ c(1:4), ylim = c(0.15,0.65), xlim = c(0.5,4.5), type = "n", pch = NA, bty = "l", xlab = "Connectivity", ylab = "Probability of zero contribution", axes = FALSE)
axis(1, at = c(1:4), cex.axis = 0.8, labels = c("Connected\n ", " Culvert/\ndiversion", "Low flow\n ", "Waterfall\n "))
par(mgp = c(2.5,1,0))
axis(2)
box(bty = "l")
...
dev.off()
```
![Marginal effect of connectivity on proportional contribution of tributary streams to the mainstem Snake River population of YCT.](ZeroInflation_Connectivity.jpg)

##### Distance

Connected only
```{r echo=FALSE, message=FALSE, results='hide'}
jpeg("/Users/jeffbaldock/Library/CloudStorage/GoogleDrive-jbaldock@uwyo.edu/Shared drives/wyo-coop-baldock/UWyoming/Snake River Cutthroat/Analyses/Snake River GSI Quarto/Obj2 Model Contribution/ZeroInflation_Distance_ConnectedOnly.jpg", units = "in", width = 4, height = 3.5, res = 1000)
...
# draws
mydraws <- mod_zoib1 %>% spread_draws(b_zi_Intercept, b_zi_z_dist, b_zi_connect_typeculvert_diversion, b_zi_connect_typelowflow, b_zi_connect_typewaterfall)
...
# set up plot
plot(seq(from = 0, to = uplim, length.out = npreds) ~ myx, xlim = x.lim, ylim = c(0.15,0.65), type = "n", pch = NA, bty = "l", xlab = "Flowline distance (km)", ylab = "Probability of zero contribution", axes = F)
axis(1, at = x.scaled, labels = x.axis)
axis(2)
box(bty = "l")
...
# Connected
pred_dist <- matrix(NA, nrow = nrow(mydraws), ncol = npreds)
for (i in 1:nrow(pred_dist)) { pred_dist[i,] <- invlogit(unlist(mydraws[i,"b_zi_Intercept"]) + unlist(mydraws[i,"b_zi_z_dist"])*myx) }
pred_lower <- apply(pred_dist, MARGIN = 2, quantile, prob = 0.025)
pred_upper <- apply(pred_dist, MARGIN = 2, quantile, prob = 0.975)
pred_median <- apply(pred_dist, MARGIN = 2, quantile, prob = 0.5)
polygon(c(myx, rev(myx)), c(pred_upper, rev(pred_lower)), col = scales::alpha(mycols[1], 0.3), lty = 0)
...
dev.off()
```
![Marginal effect of flowline distance (km) on proportional contribution of tributary streams to the mainstem Snake River population of YCT.](ZeroInflation_Distance_ConnectedOnly.jpg)

##### Area 

```{r echo=FALSE, message=FALSE, results='hide'}
jpeg("/Users/jeffbaldock/Library/CloudStorage/GoogleDrive-jbaldock@uwyo.edu/Shared drives/wyo-coop-baldock/UWyoming/Snake River Cutthroat/Analyses/Snake River GSI Quarto/Obj2 Model Contribution/ZeroInflation_Area_ConnectedOnly.jpg", units = "in", width = 4, height = 3.5, res = 1000)
...
# draws
mydraws <- mod_zoib1 %>% spread_draws(b_zi_Intercept, b_zi_z_logarea, b_zi_connect_typeculvert_diversion, b_zi_connect_typelowflow, b_zi_connect_typewaterfall)
...
# set up plot
plot(seq(from = 0, to = uplim, length.out = npreds) ~ myx, ylim = c(0.15,0.65), type = "n", pch = NA, bty = "l", xlab = expression(paste("Catchment area (km"^"2", ")")), ylab = "Probability of zero contribution", axes = F)
axis(1, at = x.scaled, labels = x.axis)
axis(2)
box(bty = "l")
...
# Connected
pred_dist <- matrix(NA, nrow = nrow(mydraws), ncol = npreds)
for (i in 1:nrow(pred_dist)) { pred_dist[i,] <- invlogit(unlist(mydraws[i,"b_zi_Intercept"]) + unlist(mydraws[i,"b_zi_z_logarea"])*myx) }
pred_lower <- apply(pred_dist, MARGIN = 2, quantile, prob = 0.025)
pred_upper <- apply(pred_dist, MARGIN = 2, quantile, prob = 0.975)
pred_median <- apply(pred_dist, MARGIN = 2, quantile, prob = 0.5)
polygon(c(myx, rev(myx)), c(pred_upper, rev(pred_lower)), col = scales::alpha(mycols[1], 0.3), lty = 0)
...
dev.off()
```
![Marginal effect of (log) catchment area (km^2) on proportional contribution of tributary streams to the mainstem Snake River population of YCT.](ZeroInflation_Area_ConnectedOnly.jpg)

##### Groundwater

Connected only
```{r echo=FALSE, message=FALSE, results='hide'}
jpeg("/Users/jeffbaldock/Library/CloudStorage/GoogleDrive-jbaldock@uwyo.edu/Shared drives/wyo-coop-baldock/UWyoming/Snake River Cutthroat/Analyses/Snake River GSI Quarto/Obj2 Model Contribution/ZeroInflation_Groundwater_ConnectedOnly.jpg", units = "in", width = 4, height = 3.5, res = 1000)
...
# draws
mydraws <- mod_zoib1 %>% spread_draws(b_zi_Intercept, b_zi_z_loggwi, b_zi_connect_typeculvert_diversion, b_zi_connect_typelowflow, b_zi_connect_typewaterfall)
...
# set up plot
plot(seq(from = 0, to = uplim, length.out = npreds) ~ myx, ylim = c(0.15,0.65), type = "n", pch = NA, bty = "l", xlab = "Groundwater index", ylab = "Probability of zero contribution", axes = F)
axis(1, at = x.scaled, labels = x.axis)
axis(2)
box(bty = "l")
...
# Connected
pred_dist <- matrix(NA, nrow = nrow(mydraws), ncol = npreds)
for (i in 1:nrow(pred_dist)) { pred_dist[i,] <- invlogit(unlist(mydraws[i,"b_zi_Intercept"]) + unlist(mydraws[i,"b_zi_z_loggwi"])*myx) }
pred_lower <- apply(pred_dist, MARGIN = 2, quantile, prob = 0.025)
pred_upper <- apply(pred_dist, MARGIN = 2, quantile, prob = 0.975)
pred_median <- apply(pred_dist, MARGIN = 2, quantile, prob = 0.5)
polygon(c(myx, rev(myx)), c(pred_upper, rev(pred_lower)), col = scales::alpha(mycols[1], 0.3), lty = 0)
...
dev.off()
```
![Marginal effect of (log) groundwater availability on proportional contribution of tributary streams to the mainstem Snake River population of YCT.](ZeroInflation_Groundwater_ConnectedOnly.jpg)
...
```{r echo=FALSE, message=FALSE, results='hide'}
jpeg("/Users/jeffbaldock/Library/CloudStorage/GoogleDrive-jbaldock@uwyo.edu/Shared drives/wyo-coop-baldock/UWyoming/Snake River Cutthroat/Analyses/Snake River GSI Quarto/Obj2 Model Contribution/Precision_Connectivity.jpg", units = "in", width = 4, height = 3.5, res = 1000)
...
# plot
plot(c(1:4) ~ c(1:4), ylim = c(0,2300), xlim = c(0.5,4.5), type = "n", pch = NA, bty = "l", xlab = "Connectivity", ylab = expression(paste("Precision, ", phi, sep = "")), axes = FALSE)
axis(1, at = c(1:4), cex.axis = 0.8, labels = c("Connected\n ", " Culvert/\ndiversion", "Low flow\n ", "Waterfall\n "))
par(mgp = c(2.5,1,0))
axis(2)
box(bty = "l")
...
dev.off()
```
![Marginal effect of connectivity on proportional contribution of tributary streams to the mainstem Snake River population of YCT.](Precision_Connectivity.jpg)

##### Distance

Connected only
```{r echo=FALSE, message=FALSE, results='hide'}
jpeg("/Users/jeffbaldock/Library/CloudStorage/GoogleDrive-jbaldock@uwyo.edu/Shared drives/wyo-coop-baldock/UWyoming/Snake River Cutthroat/Analyses/Snake River GSI Quarto/Obj2 Model Contribution/Precision_Distance_ConnectedOnly.jpg", units = "in", width = 4, height = 3.5, res = 1000)
...
# draws
mydraws <- mod_zoib1 %>% spread_draws(b_phi_Intercept, b_phi_z_dist, b_phi_connect_typeculvert_diversion, b_phi_connect_typelowflow, b_phi_connect_typewaterfall)
...
# set up plot
plot(seq(from = 0, to = uplim, length.out = npreds) ~ myx, xlim = x.lim, ylim = c(0,2300), type = "n", pch = NA, bty = "l", xlab = "Flowline distance (km)", ylab = expression(paste("Precision, ", phi, sep = "")), axes = F)
axis(1, at = x.scaled, labels = x.axis)
axis(2)
box(bty = "l")
...
# Connected
pred_dist <- matrix(NA, nrow = nrow(mydraws), ncol = npreds)
for (i in 1:nrow(pred_dist)) { pred_dist[i,] <- exp(unlist(mydraws[i,"b_phi_Intercept"]) + unlist(mydraws[i,"b_phi_z_dist"])*myx) }
pred_lower <- apply(pred_dist, MARGIN = 2, quantile, prob = 0.025)
pred_upper <- apply(pred_dist, MARGIN = 2, quantile, prob = 0.975)
pred_median <- apply(pred_dist, MARGIN = 2, quantile, prob = 0.5)
polygon(c(myx, rev(myx)), c(pred_upper, rev(pred_lower)), col = scales::alpha(mycols[1], 0.3), lty = 0)
...
# # Culvert/diversion
# pred_dist <- matrix(NA, nrow = nrow(mydraws), ncol = npreds)
# for (i in 1:nrow(pred_dist)) { pred_dist[i,] <- exp(unlist(mydraws[i,"b_phi_Intercept"]) + unlist(mydraws[i,"b_phi_z_dist"])*myx + unlist(mydraws[i,"b_phi_connect_typeculvert_diversion"])) }
# pred_lower <- apply(pred_dist, MARGIN = 2, quantile, prob = 0.025)
# pred_upper <- apply(pred_dist, MARGIN = 2, quantile, prob = 0.975)
# pred_median <- apply(pred_dist, MARGIN = 2, quantile, prob = 0.5)
# polygon(c(myx, rev(myx)), c(pred_upper, rev(pred_lower)), col = scales::alpha(mycols[2], 0.3), lty = 0)
...
# # Low flow
# pred_dist <- matrix(NA, nrow = nrow(mydraws), ncol = npreds)
# for (i in 1:nrow(pred_dist)) { pred_dist[i,] <- exp(unlist(mydraws[i,"b_phi_Intercept"]) + unlist(mydraws[i,"b_phi_z_dist"])*myx + unlist(mydraws[i,"b_phi_connect_typelowflow"])) }
# pred_lower <- apply(pred_dist, MARGIN = 2, quantile, prob = 0.025)
# pred_upper <- apply(pred_dist, MARGIN = 2, quantile, prob = 0.975)
# pred_median <- apply(pred_dist, MARGIN = 2, quantile, prob = 0.5)
# polygon(c(myx, rev(myx)), c(pred_upper, rev(pred_lower)), col = scales::alpha(mycols[3], 0.3), lty = 0)
...
# # waterfall
# pred_dist <- matrix(NA, nrow = nrow(mydraws), ncol = npreds)
# for (i in 1:nrow(pred_dist)) { pred_dist[i,] <- exp(unlist(mydraws[i,"b_phi_Intercept"]) + unlist(mydraws[i,"b_phi_z_dist"])*myx + unlist(mydraws[i,"b_phi_connect_typewaterfall"])) }
# pred_lower <- apply(pred_dist, MARGIN = 2, quantile, prob = 0.025)
# pred_upper <- apply(pred_dist, MARGIN = 2, quantile, prob = 0.975)
# pred_median <- apply(pred_dist, MARGIN = 2, quantile, prob = 0.5)
# polygon(c(myx, rev(myx)), c(pred_upper, rev(pred_lower)), col = scales::alpha(mycols[4], 0.3), lty = 0)
...
dev.off()
```
![Marginal effect of flowline distance (km) on proportional contribution of tributary streams to the mainstem Snake River population of YCT.](Precision_Distance_ConnectedOnly.jpg)

##### Area 

```{r echo=FALSE, message=FALSE, results='hide'}
jpeg("/Users/jeffbaldock/Library/CloudStorage/GoogleDrive-jbaldock@uwyo.edu/Shared drives/wyo-coop-baldock/UWyoming/Snake River Cutthroat/Analyses/Snake River GSI Quarto/Obj2 Model Contribution/Precision_Area_ConnectedOnly.jpg", units = "in", width = 4, height = 3.5, res = 1000)
...
# draws
mydraws <- mod_zoib1 %>% spread_draws(b_phi_Intercept, b_phi_z_logarea, b_phi_connect_typeculvert_diversion, b_phi_connect_typelowflow, b_phi_connect_typewaterfall)
...
# set up plot
plot(seq(from = 0, to = uplim, length.out = npreds) ~ myx, ylim = c(0,2300), type = "n", pch = NA, bty = "l", xlab = expression(paste("Catchment area (km"^"2", ")")), ylab = expression(paste("Precision, ", phi, sep = "")), axes = F)
axis(1, at = x.scaled, labels = x.axis)
axis(2)
box(bty = "l")
...
# Connected
pred_dist <- matrix(NA, nrow = nrow(mydraws), ncol = npreds)
for (i in 1:nrow(pred_dist)) { pred_dist[i,] <- exp(unlist(mydraws[i,"b_phi_Intercept"]) + unlist(mydraws[i,"b_phi_z_logarea"])*myx) }
pred_lower <- apply(pred_dist, MARGIN = 2, quantile, prob = 0.025)
pred_upper <- apply(pred_dist, MARGIN = 2, quantile, prob = 0.975)
pred_median <- apply(pred_dist, MARGIN = 2, quantile, prob = 0.5)
polygon(c(myx, rev(myx)), c(pred_upper, rev(pred_lower)), col = scales::alpha(mycols[1], 0.3), lty = 0)
...
dev.off()
```
![Marginal effect of (log) catchment area (km^2) on proportional contribution of tributary streams to the mainstem Snake River population of YCT.](Precision_Area_ConnectedOnly.jpg)
...
Connected only
```{r echo=FALSE, message=FALSE, results='hide'}
jpeg("/Users/jeffbaldock/Library/CloudStorage/GoogleDrive-jbaldock@uwyo.edu/Shared drives/wyo-coop-baldock/UWyoming/Snake River Cutthroat/Analyses/Snake River GSI Quarto/Obj2 Model Contribution/Precision_Groundwater_ConnectedOnly.jpg", units = "in", width = 4, height = 3.5, res = 1000)
...
# draws
mydraws <- mod_zoib1 %>% spread_draws(b_phi_Intercept, b_phi_z_loggwi, b_phi_connect_typeculvert_diversion, b_phi_connect_typelowflow, b_phi_connect_typewaterfall)
...
# set up plot
plot(seq(from = 0, to = uplim, length.out = npreds) ~ myx, ylim = c(0,2300), type = "n", pch = NA, bty = "l", xlab = "Groundwater index", ylab = expression(paste("Precision, ", phi, sep = "")), axes = F)
axis(1, at = x.scaled, labels = x.axis)
axis(2)
box(bty = "l")
...
# Connected
pred_dist <- matrix(NA, nrow = nrow(mydraws), ncol = npreds)
for (i in 1:nrow(pred_dist)) { pred_dist[i,] <- exp(unlist(mydraws[i,"b_phi_Intercept"]) + unlist(mydraws[i,"b_phi_z_loggwi"])*myx) }
pred_lower <- apply(pred_dist, MARGIN = 2, quantile, prob = 0.025)
pred_upper <- apply(pred_dist, MARGIN = 2, quantile, prob = 0.975)
pred_median <- apply(pred_dist, MARGIN = 2, quantile, prob = 0.5)
polygon(c(myx, rev(myx)), c(pred_upper, rev(pred_lower)), col = scales::alpha(mycols[1], 0.3), lty = 0)
...
dev.off()
```
![Marginal effect of (log) groundwater availability on proportional contribution of tributary streams to the mainstem Snake River population of YCT.](Precision_Groundwater_ConnectedOnly.jpg)
